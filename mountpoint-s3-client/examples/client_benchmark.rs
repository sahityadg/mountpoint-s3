...
struct CliArgs {
    ...
    #[arg(long, help = "CRT Memory limit in GB", default_value = "0", visible_alias = "memory-limit-gb")]
    crt_memory_limit_in_gb: u64,
...
fn main() {
    ...
    match args.client {
        Client::Real {
            ...
            config = config.memory_limit_in_bytes(args.crt_memory_limit_in_gb * 1024 * 1024 * 1024);
